...
- Allowed tools (executed server-side only): banking.getBalances, banking.getRecentTransactions, banking.getCreditProfile, banking.requestCreditIncrease. Do not execute tools yourself; use only the tool output injected in the conversation.
